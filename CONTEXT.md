...
La base tecnica actual ya cubre autenticacion, reservas, cancelaciones, metricas base, saturacion actual, reglas en BD y panel admin de lectura. Lo que sigue pendiente o incompleto es el flujo completo de check-in, el no-show automatico, la recomendacion historica de franjas, la gestion admin de suspensiones y la validacion de esos casos con pruebas formales.
